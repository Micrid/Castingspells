...
public class Main {
    ...
    public void addItemLoc(Location location, String name,String description, boolean moveable){
        location.inventory.add(name,description,moveable);
    }

    public void initLoc() {
        setLocation(attic,"чердак", "Вы на чердаке старого дома.\nВ углу видна гигантская горелка.\nВниз ведет лестница.\n");
        addItemLoc(attic,"ведро","пустое ведро", true);
        addItemLoc(attic,"бутылка виски","бутылка дорого виски", true);
        addItemLoc(attic,"волшебник","", false);
